#!/usr/bin/env bash
# 09-22 20:50 사용자: ③ 뒤에 보너스 4→6 짝(③b) 추가. 순서: (R0.5) → ③ FN1.0 S·A → ③b bonus6 S·A → ④ v5a S·A → ⑤ P0.05·R1 → ⑥ P0.05·R0.5 → ⑦ P0.1·R1
...
SW="--set agent.swirl.p_delta=0.01 --set agent.swirl.alpha=0.1 --set agent.swirl.R=1.0"
...
echo "- $(date '+%H:%M') chain_0922j 완료" >> $L; touch $B/CHAIN_DONE
