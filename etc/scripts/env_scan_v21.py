...
CELLS = {'frame': dict(STAGE, GAMMA='0.85', EPS_DECAY='4000', HOVER_DWELL='5'),
         'g95d8k': dict(STAGE, GAMMA='0.95', EPS_DECAY='8000', HOVER_DWELL='5'),
         'shiftN04': dict(STAGE, GAMMA='0.95', EPS_DECAY='8000', HOVER_DWELL='5', SURR_SHIFT_EP='100', SURR_SHIFT_NOISE='0.4'),
         'st03w20p30': dict(STAGE, GAMMA='0.85', EPS_DECAY='4000', HOVER_DWELL='5', SURR_WEAK_INTERP='1', ATK_DELTA_LO='0.03', ATK_WEAK_HI='0.2', ATK_P_UPPER='0.3'),
         'st03w10p30': dict(STAGE, GAMMA='0.85', EPS_DECAY='4000', HOVER_DWELL='5', SURR_WEAK_INTERP='1', ATK_DELTA_LO='0.03', ATK_WEAK_HI='0.1', ATK_P_UPPER='0.3'),
         'noise1.5': dict(STAGE, GAMMA='0.85', EPS_DECAY='4000', HOVER_DWELL='5')}
NOISE = {'noise1.5': 1.5}
for cn, cv in CELLS.items():
    for hp in ('0.05', '0.15'):
        for sd in (42, 43, 44, 45, 46):
            jobs.append((f'{cn}_AdamNoAms{hp}_s{sd}', dict(AG['Adam'][0], ADAM_AMSGRAD='0'), 'adam', sd, dict(cv, EPS_HOVER_P=hp)))
mine = jobs[WID::NW]; out = {}
try: out = json.load(open(f'{N}/v21_w{WID}.json'))
...
for name, env, ag, sd, extra in mine:
    ...
    json.dump(out, open(f'{N}/v21_w{WID}.json', 'w'), default=float)
open(f'{N}/V21_w{WID}_DONE', 'w').close(); print(f'[w{WID}] 완료', flush=True)
