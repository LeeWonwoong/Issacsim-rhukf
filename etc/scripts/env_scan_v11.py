...
A2 = dict(STAGE, REWARD_MODE='A2', A2_C0='0.5', A2_F='1.0', A2_INSTALL='1', EPS_DECAY='12000')
CELLS = {'A2g97': dict(A2, GAMMA='0.97', A2_C='3.0', A2_P='0.3'), 'A2p25': dict(A2, GAMMA='0.95', A2_C='6.0', A2_P='0.25')}
...
try: out = json.load(open(f'{N}/v11_w{WID}.json'))
...
for name, env, ag, sd, extra in mine:
    ...
    json.dump(out, open(f'{N}/v11_w{WID}.json', 'w'), default=float)
open(f'{N}/V11_w{WID}_DONE', 'w').close(); print(f'[w{WID}] 완료', flush=True)
