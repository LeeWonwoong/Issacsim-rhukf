#!/usr/bin/env python3
"""build_pool_v5 (2026-09-12) — 확정 환경 풀: G2+ 필터 · 클립 4.0 · failsafe hover 데이터(cert/A-1/A-2/A-4/A-5/B/W/D/failsafe_dh/nomod) + 약공격(weakfloor, gapcheck, on15/on5 무풍)
...
NEW = [f'{R}/{d}' for d in ('cert_A','cert_A1','cert_A2lo','cert_A2hi','cert_A4_090','cert_A5_085','cert_B15','cert_B20','cert_B25','cert_B40','cert_B84_15','cert_B84_20','cert_B84_25','cert_W','cert_D_off','failsafe_dh','nomod')]
...
if __name__ == '__main__':
    ...
    os.makedirs(f'{R}/night', exist_ok=True); np.savez(f'{R}/night/train_pool_v5.npz', **out); print(f'saved {R}/night/train_pool_v5.npz 총 {tot} 프레임', flush=True)
